...
const mockPremiumData = {
  ...
  location: '충청북도',
  productRankCode: '04', // 상급
  date: new Date('2024-06-23T09:30:00'),
  grade: '상급',
...
export const DifferentProduct: Story = {
  args: {
    data: {
      ...
      productName: '유기농 상추',
      location: '경기도',
      productRankCode: '05', // 중급
      date: new Date('2024-06-22T14:20:00'),
      grade: '중급',
...
export const HighPriceProduct: Story = {
  args: {
    data: {
      ...
      productName: '프리미엄 수박',
      location: '제주특별자치도',
      productRankCode: '06', // 하급 (테스트용)
      date: new Date('2024-06-21T16:45:00'),
      grade: '하급',
