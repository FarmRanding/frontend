...
export const PremiumMemberAccess: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '프리미엄 회원이 프리미엄 가격 제안에 접근한 상태입니다. 프리미엄 플러스 업그레이드 안내가 표시됩니다.'
      }
    },
    mockData: {
      user: {
...
export const PremiumPlusAccess: Story = {
  name: '프리미엄 플러스 회원 접근',
  parameters: {
    docs: {
      description: {
        story: '프리미엄 플러스 회원이 프리미엄 가격 제안에 접근한 상태입니다. 모든 기능을 사용할 수 있습니다.'
      }
    },
    mockData: {
      user: {
