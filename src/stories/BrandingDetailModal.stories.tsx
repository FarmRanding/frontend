...
const mockBrandingHistory = {
  ...
  imageUrl: 'https://placehold.co/200x200/ff6b6b/ffffff?text=🍎',
...
const longDescriptionHistory = {
  ...
  imageUrl: 'https://placehold.co/200x200/8B4513/ffffff?text=🥔',
  createdAt: '2025.05.15'
};
...
const vegetableHistory = {
  ...
  imageUrl: 'https://placehold.co/200x200/32CD32/ffffff?text=🌶️',
...
const tomatoHistory = {
  ...
  imageUrl: 'https://placehold.co/200x200/FF6347/ffffff?text=🍅',
  createdAt: '2025.05.14'
};
...
const meta: Meta<typeof BrandingDetailModal> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '브랜딩 이력의 상세 정보를 보여주는 모달 컴포넌트입니다. 복사하기 버튼으로 브랜드명, 홍보 문구, 스토리를 복사할 수 있고, 로고 이미지를 다운로드할 수 있습니다.'
      }
    }
  },
  decorators: [
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '브랜딩 상세 모달의 기본 상태입니다. 브랜드명, 홍보 문구, 스토리 각각에 복사하기 버튼이 있고, 로고 이미지에 다운로드 버튼이 있습니다.'
      }
    }
  }
};
...
export const WithoutImage: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '이미지가 없는 브랜딩 상세 모달입니다. 기본 플레이스홀더 이미지가 표시되고 다운로드 버튼은 표시되지 않습니다.'
      }
    }
  }
};
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '브랜드 이미지에 마우스를 올리면 샤머 효과와 스케일 애니메이션, 그리고 다운로드 버튼을 볼 수 있습니다. 모달 외부를 클릭하거나 닫기 버튼을 누르면 모달이 닫힙니다. 브랜드명, 홍보문구, 스토리가 모두 표시되어 완전한 브랜딩 정보를 확인할 수 있습니다.'
      }
    }
  }
}; 